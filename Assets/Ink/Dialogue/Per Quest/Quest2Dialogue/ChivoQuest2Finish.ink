...
=== HereToHelp ===
Ah, a real hero indeed! 
The biggest problem with the Kettle is that we have no idea what is wrong with it.
...
=== Kettle ===
Hasn't Chobo informed you? Our Kettle is broken, which is freezing our planet.
The biggest problem with the Kettle is that we have no idea what is wrong with it.
There could be multiple factors playing a role here, but we don't know how to rule them out.
    + Where can I start?
    -> Start
