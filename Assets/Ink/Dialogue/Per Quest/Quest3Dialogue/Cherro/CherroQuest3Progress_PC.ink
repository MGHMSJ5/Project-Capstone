...
//Explain the controls for pulse again, if they forgot - PC controls.
...
===Forgot===
Alright, when you press the Q-Key on your keyboard a pulse happens around the player that can trigger panels and doors.
+Got it!
->Remember
